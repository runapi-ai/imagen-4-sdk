package ai.runapi.imagen4.resources;
...
public final class TextToImageResource extends Imagen4Resource {
  /** API endpoint path for text to image operations. */
  public static final String ENDPOINT = "/api/v1/imagen_4/text_to_image";
