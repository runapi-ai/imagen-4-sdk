...
- For a one-off artifact or result, use the registered `imagen-4` service in the `runapi` CLI. If the installed command catalog does not list it, stop and report the missing service instead of inventing a command.
...
runapi imagen-4 <operation> --help
curl --fail --location https://runapi.ai/docs/api/imagen-4/<operation>.md --output contract.md
```
...
```shell
runapi imagen-4 <operation> --async --input-file request.json > task.json
...
```shell
runapi wait "$task_id" --service imagen-4 --action <operation> > result.json
```
...
- SDK integration: https://github.com/runapi-ai/imagen-4-sdk

## Variants
- `imagen-4`: https://runapi.ai/models/imagen-4/imagen-4.md
- `imagen-4-fast`: https://runapi.ai/models/imagen-4/fast.md
- `imagen-4-pro-remix-image`: https://runapi.ai/models/imagen-4/pro-remix-image.md
- `imagen-4-ultra`: https://runapi.ai/models/imagen-4/ultra.md
